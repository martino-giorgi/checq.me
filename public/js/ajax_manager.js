function init(){
    API.get_classrooms().then((response)=>{
        document.getElementById("classroom_list").innerHTML = ejs.views_manager_partial_class_list({classrooms: response.classrooms});
        // store the current user
        API.user = response["user"];
        document.getElementById("form").innerHTML = ejs.views_manager_partial_class_add_form({user: API.user});
...
function submit_form(){
    ...
    API.post_classroom(body).then((new_classroom)=>{
        document.getElementById("classroom_list").innerHTML += ejs.views_manager_partial_class_list({classrooms: [new_classroom]});
